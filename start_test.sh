...
case "$OS" in
    "Linux")
        ...
        export KEYCLOAK_DATABASE_NAME=prefectura_cotopaxi_keycloak
    ...
    "macOS")
        ...
        export KEYCLOAK_DATABASE_NAME=vetsc_keycloak
    ...
    "Windows")
        ...
        export KEYCLOAK_DB_PASSWORD=101191
