  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        ...
        <h1>Bienvenido a <strong>VETSC</strong></h1>
      </div>
      <div class="row">
        <div class="col-xs-12 col-sm-4">
          <div class="card-pf h-l">
            ...
            <#elseif errorMessage?has_content>
                ...
                <h3><img src="welcome-content/user.png">Consola de administración</h3>
            <#elseif bootstrap>
                <#if localUser>
            ...
            <#if bootstrap && localUser>
                <form method="post" class="welcome-form">
                    ...
                    <button id="create-button" type="submit" class="btn btn-primary">Crear</button>
                </form>
            </#if>
            <div class="welcome-primary-link">
              <h3><a href="admin/"><img src="welcome-content/user.png">Consola de Administración <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
              <div class="description">
                Administra todos los aspectos del servidor
              </div>
            </div>
          </div>
        </div>
      ...
      <div class='footer'>
        <#if properties.displayCommunityLinks = "true">
            <div>© VETSC todos los derechos reservador.</div>
        </#if>
      </div>
    </div>
  </div>
